...
class SelectTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $select = new \Rapid\Form\Select(array(), 'Select');
        $this->assertInstanceOf('\Rapid\Form\Select', $select);
    ...
    {
        $select = new \Rapid\Form\Select(array('val1' => 'Value #1'), 'Select');
        $select->setAttribute('name', 'foo');
    ...
    {
        $select = new \Rapid\Form\Select(array('val1' => 'Value #1', 'val2' => 'Value #2'), 'Select');
        $select->setAttribute('name', 'foo');
